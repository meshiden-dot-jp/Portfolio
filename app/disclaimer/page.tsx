...
const page = () => {
    return (
        <div  className='sm:w-[70%] w-[90%] m-auto pb-32'>
            <h5 className='text-center'>免責事項</h5>

            <p>本ウェブサイト（以下、「当サイト」とします）をご利用いただく際には、以下の免責事項をお読みいただき、同意された場合にのみご利用ください。</p>

            <h6>情報の正確性について</h6>
            <p>当サイトでは、可能な限り正確な情報を提供するよう努めておりますが、内容の正確性や完全性を保証するものではありません。掲載されている情報に基づいて行動する際は、自己責任でお願いいたします。</p>

            <h6>コンテンツの変更・削除について</h6>
            ...
            <h6>免責事項に関するお問い合わせ</h6>
            <p>免責事項に関するお問い合わせは、当サイトの運営者までご連絡ください。</p>
        </div>
    )
}
