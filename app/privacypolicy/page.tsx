...
const page = () => {
    return (
        <div  className='sm:w-[70%] w-[90%] m-auto pb-32'>
            <h5 className='text-center'>プライバシーポリシー</h5>
            <p>本プライバシーポリシーは、当サイト（以下、「当サイト」）における個人情報の取扱いについて説明するものです。</p>
            ...
            <p>メールアドレス: <a href="mailto:example@example.com">example@example.com</a></p>
