...
const content = () => {
    return (
        <div className='sm:w-[70%] m-auto py-28 w-[90%]'>
            <div className='sm:w-7/12 w-full ml-auto'>
                <p>
                ...
                <h4>SNS</h4>
                <ul className='text-[28px] flex gap-x-10 justify-center'>
